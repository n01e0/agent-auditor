...
See [`live-proxy-interception-foundation.md`](live-proxy-interception-foundation.md) for the concrete P13-1 boundary, [`live-proxy-http-request-contract.md`](live-proxy-http-request-contract.md) for the concrete P13-2 request model, [`generic-live-action-envelope.md`](generic-live-action-envelope.md) for the concrete P13-3 `agenta-core` live envelope, [`generic-rest-live-preview-path.md`](generic-rest-live-preview-path.md) for the checked-in P13-5 generic REST live preview adapter, [`provider-live-preview-adapter-boundaries.md`](provider-live-preview-adapter-boundaries.md) for the checked-in P13-6 provider semantic live preview adapters, [`live-preview-record-reflection.md`](live-preview-record-reflection.md) for the checked-in P13-7 preview policy / approval / audit reflection path, [`live-preview-mode-semantics.md`](live-preview-mode-semantics.md) for the checked-in P13-8 mode projection used by status and record reflection, [`live-proxy-test-fixtures.md`](live-proxy-test-fixtures.md) for the checked-in P13-9 fixture catalog and smoke tests, [`live-proxy-local-runbook.md`](live-proxy-local-runbook.md) for the local contributor workflow, and [`live-proxy-known-constraints.md`](live-proxy-known-constraints.md) for the currently acknowledged PoC limits.
